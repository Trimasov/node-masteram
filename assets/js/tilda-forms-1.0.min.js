                    ...
                    switch (rule) {
                        ...
                        case 'phone':
                            ...
                            if (valnospace.length > 0 && !valnospace.match(regExp)) {
                                ...
                                if (str.indexOf('000') == 1 || str.indexOf('111') == 1 || str.indexOf('222') == 1 || str.indexOf('333') == 1 || str.indexOf('444') == 1 || (str.indexOf('555') == 1 && str.substring(0, 1) != '0') || (str.indexOf('666') == 1 && str.substring(0, 1) != '0') || (str.indexOf('8888') == 1 && str.substring(0, 1) != '4')) {
                                    error.type.push('phone')
                                }
                            }
                            break;
